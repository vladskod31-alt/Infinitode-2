/* INFINITODE 4 — canvas vector renderer */
(function () {
  'use strict';
  ...
  class Renderer {
    ...
    drawTower(c, g, tw) {
      ...
      if (tw.level >= 10) {
        c.strokeStyle = '#ffe27a'; c.lineWidth = 2; c.globalAlpha = 0.6 + Math.sin(this.t * 4) * 0.3;
    ...
    drawHead(c, g, tw) {
      const d = tw.def;
      c.save();
      const rotKinds = ['basic', 'cannon', 'multishot', 'sniper', 'minigun', 'venom', 'missile', 'flame', 'laser', 'gauss', 'antiair'];
